...
/*this is delet quer*/
mysqli_query($con,"delete from user_info_backup where user_id='$user_id'")or die("query is incorrect...");
}
                ...
                <div class="card-body">
                    <div class="table-responsive ps">
                        <table class="table tablesorter table-hover" id="">
                            ...
                            <tbody>
                                <?php 
                        $result=mysqli_query($con,"select user_id, email, password from user_info_backup")or die ("query 2 incorrect.......");
