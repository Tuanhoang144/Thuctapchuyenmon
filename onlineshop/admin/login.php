...
if(isset($_POST["login"])){
    ...
    $sqlLogin= "select * from admin_info where admin_name='$userName ' AND `admin_password` ='$password'";
                    ...
                    <div class="card-body">
                        ...
                        <form class="form-signin" method="post">
                            <div class="form-label-group">
                                <input type="text" id="admin_name" class="form-control"  placeholder="Email address"
                                    name="admin_name" required autofocus>
                                <label for="admin_name">Email address</label>
                            </div>
