                ...
                <tbody>
                    <?php
                     if(isset($_SESSION["uid"])){
                        $query = $con->query("SELECT * FROM `orders_info` where phuongthucthanhtoan = 'null'  or phuongthucthanhtoan = '' or phuongthucthanhtoan is NULL and user_id ='$_SESSION[uid]'") or die(mysqli_error());
